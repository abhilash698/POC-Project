...
<head>
    ...
    {!! Html::style('assets/css/select/select2.min.css') !!} 
    {!! Html::style('assets/css/switchery/switchery.min.css') !!} 
...
<body class="nav-md">
    ...
    <div class="container body">
        ...
        <div class="main_container">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            {!! HTML::image('assets/images/img.jpg', 'profile', array('class' => 'img-circle profile_img')) !!}
                            <!-- <img src="images/img.jpg" alt="..." class="img-circle profile_img"> -->
                        </div>
                        <div class="profile_info">
                            <span>Welcome,</span>
                            <h2>{{ isset(Auth::user()->name) ? Auth::user()->name : 'Admin'  }} </h2>
                        </div>
                    </div>
                    <!-- /menu prile quick info -->
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li class="nv active"><a><i class="fa fa-home"></i> Stores </a>
                                </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    {!! HTML::image('assets/images/img.jpg') !!} {{ isset(Auth::user()->name) ? Auth::user()->name : 'Admin'  }} 
            ...
            <div class="right_col" role="main">
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">Store Admin! Dashboard by <a>abhilash</a>. |
                            <span class="lead"> <i class="fa fa-paw"></i> Store Admin!</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
    ...
    {!! Html::script('assets/js/tags/jquery.tagsinput.min.js') !!} 
    {!! Html::script('assets/js/switchery/switchery.min.js') !!} 
   ...
   <!-- input tags -->
    ...
    <!-- worldmap -->
    {!! Html::script('assets/js/maps/jquery-jvectormap-2.0.1.min.js') !!} 
    {!! Html::script('assets/js/maps/gdp-data.js"') !!} 
    {!! Html::script('assets/js/maps/jquery-jvectormap-world-mill-en.js') !!} 
    {!! Html::script('assets/js/maps/jquery-jvectormap-us-aea-en.js') !!} 
