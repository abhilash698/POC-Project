                    ...
                    <div class="page-title">
                        ...
                        <!-- <div class="title_right">
                            <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right top_search">
                                ...
                                <a href="/storeadmin/addstore"><button type="button" class="btn btn-primary">Add Store</button></a>
                            ...
                            <div class="x_panel">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="/storeadmin/editstore/{{ $store['id'] }}">Edit</a>
                                                </li>
                                ...
                                <div class="x_content" style="display: none;">
                                    ...
                                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <ul class="nav nav-pills" role="tablist" style='float:right;'>
                                                <li role="presentation" class="dropdown">
                                                    ...
                                                    <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/storeadmin/addelements/{{ $form['id'] }}">Add Elements</a>
                                                        </li>
                                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/storeadmin/editform/{{ $form['id'] }}">Edit</a>
                                                        </li>
                                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/storeadmin/deleteform/{{ $form['id'] }}">Delete</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <a href="/storeadmin/addform/{{ $store['id'] }}" style='float:right;'><button type="button" class="btn btn-primary">Add Form</button></a>
