                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="elementform" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <a href="/superadmin/stores" class="btn btn-primary">Done</a>
                                                <button id='saveoption' type="submit" class="btn btn-success">add</button>
                                            </div>
                                        </div>
